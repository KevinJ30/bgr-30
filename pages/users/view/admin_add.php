			...
			<form method="POST" action="#">
				<fieldset>
					...
					<div class="input">
						...
						<input name="username" type="text" placeholder="identifiant" value="<?= isset($validator->errorMessage['username']['chaine']) ? $validator->errorMessage['username']['chaine'] : null; ?>" />
				...
				<fieldset>
					...
					<div class="input">
						<label>Nom :</label>
						<input name="nom" type="text" placeholder="Nom"  value="<?= isset($validator->errorMessage['nom']['chaine']) ? $validator->errorMessage['nom']['chaine'] : null; ?>"/>
						<label class="error"><?= isset($validator->errorMessage['nom']['chaine']) ? $validator->errorMessage['nom']['message'] : null; ?></label>
					</div>

					<div class="input">
						<label>Prenom :</label>
						<input name="prenom" type="text" placeholder="Prenom" value="<?= isset($validator->errorMessage['prenom']['chaine']) ? $validator->errorMessage['prenom']['chaine'] : null; ?>"/>
						<label class="error"><?= isset($validator->errorMessage['prenom']['chaine']) ? $validator->errorMessage['prenom']['message'] : null; ?></label>
					</div>

					<div class="input">
						<input type="checkbox" name="active" value="1" /><label>Activer le compte?</label>
					</div>
				...
				<div class="input">
					<input type="submit" value="Sauvegarder le compte">
				</div>
			</form>
	</article>
<?php
