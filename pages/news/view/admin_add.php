		...
		<form method="POST" action="#">
			<fieldset>
				...
				<div class="input">
					...
					<input type="text" name="title" value="<?= isset($validator->errorMessage['title']['chaine']) ? $validator->errorMessage['title']['chaine'] : null; ?>">
					<label class="error"><?= isset($validator->errorMessage['title']['chaine']) ? $validator->errorMessage['title']['message'] : null; ?></label>
				</div>
				
				<div class="input">
					<label>Titre de l'actualité :</label>
					<textarea name="content" placeholder="Insérer le contenu de votre article."><?= isset($validator->errorMessage['content']['chaine']) ? $validator->errorMessage['content']['chaine'] : null; ?></textarea>
					<label class="error"><?= isset($validator->errorMessage['content']['chaine']) ? $validator->errorMessage['content']['message'] : null; ?></label>
				</div>
				
				<div class="input">
					<input type="checkbox" name="status" value="1" /><label>Voulez-vous directement publier cet actualité ?</label>
				</div>
			</fieldset>
