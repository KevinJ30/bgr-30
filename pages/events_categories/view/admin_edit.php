		...
		<form method="POST" action="#" class="large-6 alignCenter">
			<fieldset>
				...
				<div class="input">
					...
					<input type="text" name="name" value="<?= isset($validator->errorMessage['name']['chaine']) ? $validator->errorMessage['name']['chaine'] : $categorie->name; ?>">
				...
				<div class="input">
					...
					<input type="text" name="color" value="<?= isset($validator->errorMessage['color']['chaine']) ? $validator->errorMessage['color']['chaine'] : $categorie->color; ?>">
					<label class="error"><?= isset($validator->errorMessage['color']['chaine']) ? $validator->errorMessage['color']['message'] : null; ?></label>
				</div>
				<div class="input">
					<input type="checkbox" name="actif" value="1" <?= $categorie->actif != 0 ? 'checked="checked"' : null; ?> /><label>Voulez-vous directement publier cette categorie ?</label>
				</div>
			</fieldset>
			<div class="input">
